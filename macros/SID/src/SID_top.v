...
module sid_top(
	...
	output reg [11:0] sample_raw_1_dac,
	output reg [11:0] sample_raw_2_dac,
...
always @(posedge clk) begin
    if(rst_n) begin
        if(sample_ready_1) begin
            sample_raw_1 <= full_sample_1[14:3];
            sample_raw_1_dac <= 12'hFFF - full_sample_1[14:3];
        end
        if(sample_ready_2) begin
            sample_raw_2 <= full_sample_2[14:3];
            sample_raw_2_dac <= 12'hFFF - full_sample_2[14:3];
        end
    end
end
